...
protoc -I=../.. --go_out=. --go_opt=Mprotos/apm_test_otel_client.proto=. --go-grpc_out=. --go-grpc_opt=Mprotos/apm_test_otel_client.proto=. ../../protos/apm_test_otel_client.proto
