...
from utils import scenarios, interfaces, weblog, features, bug, irrelevant, context
...
class Test_Debugger_PII_Redaction(base._Base_Debugger_Snapshot_Test):
    ...
    @irrelevant(context.library < "java@1.34", reason="keywords are not fully redacted")
    @irrelevant(context.library < "dotnet@2.51", reason="keywords are not fully redacted")
