...
class Test_Debugger_Coordinated_Sampling(debugger.BaseDebuggerTest):
    ...
    def setup_coordinated_per_trace_sampling(self):
        ...
        for probe in probes:
            ...
            # Sample below 100% so that some traces are dropped entirely.
    ...
    def test_coordinated_per_trace_sampling(self):
        ...
        # Fully dropped traces emit nothing and so never appear above.
        dropped = self._INVOCATIONS - len(probes_by_trace)
