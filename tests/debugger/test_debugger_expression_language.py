...
class Test_Debugger_Expression_Language(base._Base_Debugger_Test):
    ...
    def setup_expression_language_collection_operations(self):
        message_map, probes = self._create_expression_probes(
            ...
            expressions=[
                ...
                # ["Hash0 any gt 1", False, Dsl("any", [Dsl("ref", "h0"), Dsl("gt", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 1])])],
                # ["Hash1 any gt 1", False, Dsl("any", [Dsl("ref", "h1"), Dsl("gt", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 1])])],
                ["Hash5 any gt 1", True, Dsl("any", [Dsl("ref", "h5"), Dsl("gt", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 1])])],
                ##### all
                ...
                # ["Hash0 all ge 0", True, Dsl("all", [Dsl("ref", "h0"), Dsl("ge", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 0])])],
                ["Hash1 all ge 0", True, Dsl("all", [Dsl("ref", "h1"), Dsl("ge", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 0])])],
                # ["Hash5 all ge 1", False, Dsl("all", [Dsl("reff", "h5"), Dsl("ge", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 1])])],
                ##### filter
                # [
                ...
                #     0,
                #     Dsl("len", Dsl("filter", [Dsl("ref", "h0"), Dsl("lt", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 2])])),
                # ],
                [
                    "Hash1 len filter lt 2",
                    1,
                    Dsl("len", Dsl("filter", [Dsl("ref", "h1"), Dsl("lt", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 2])])),
                ],
                [
                    "Hash5 len filter lt 2",
                    2,
                    Dsl("len", Dsl("filter", [Dsl("ref", "h5"), Dsl("lt", [Dsl("getmember", [Dsl("ref", "@it"), self._get_hash_value()]), 2])])),
                ],
            ],
        )
    ...
    def _get_type(self, value_type):
        ...
        elif Test_Debugger_Expression_Language.tracer["language"] == "java":
            if value_type == "int":
