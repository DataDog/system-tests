...
class Test_DdtraceSchemas:
    def test_library(self):
        known_bugs = [
            ...
            SchemaBug(
                endpoint="/debugger/v1/input",
                data_path="$[].debugger.product",
                condition=context.library == "dotnet",
                ticket="DEBUG-XXXX",
            ),
            SchemaBug(
                endpoint="/debugger/v1/input",
                data_path="$[].debugger.type",
                condition=context.library == "dotnet",
                ticket="DEBUG-XXXX",
            ),
            SchemaBug(
            ...
            SchemaBug(
                endpoint="/debugger/v1/input",
                data_path="$[].debugger.snapshot",
                condition=context.library == "nodejs",
                ticket="DEBUG-XXXX",
                error_validator="additionalProperties",
                error_message_pattern=r"'process_tags' was unexpected",
            ),
            SchemaBug(
                endpoint="/debugger/v2/input",
                data_path="$[].debugger.snapshot",
            ...
            SchemaBug(
                ...
                ticket="DEBUG-XXXX",
                error_validator="additionalProperties",
                error_message_pattern=r"'hostname' was unexpected",
            ),
            SchemaBug(
                endpoint="/debugger/v2/input",
                data_path="$[]",
            ...
            SchemaBug(
                ...
                ticket="DEBUG-XXXX",
                error_validator="additionalProperties",
                error_message_pattern=r"'notSerializedReason' was unexpected",
            ),
            SchemaBug(
                endpoint="/debugger/v2/input",
                data_path=None,
            ...
            SchemaBug(
                endpoint="/debugger/v1/input",
                data_path="$[].debugger.snapshot.probe.location",
                condition=context.library == "golang",
                ticket="DEBUG-XXXX",
                error_validator="additionalProperties",
                error_message_pattern=r"'line' was unexpected",
            ),
            SchemaBug(
                endpoint="/debugger/v2/input",
                data_path="$[].debugger.snapshot.probe.location",
