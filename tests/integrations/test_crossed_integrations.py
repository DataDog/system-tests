...
class Test_PythonKafka:
    ...
    def get_traces(self, topic):
        ...
        for data in interfaces.library.get_data(path_filters=paths):
            ...
            for trace in traces:
                for span in trace:
                    if topic == self.get_topic_from_span(span):
                        yield data, trace
                        break
    ...
    def setup_produce(self):
        ...
        self.production_response = weblog.get("/kafka/produce", params={"topic": "DistributedTracing"})
    ...
    def test_produce(self):
        ...
        assert "parent_id" in consumer_span_from_consumer.keys()
    ...
    def setup_consume(self):
        ...
        self.production_response = python_buddy.get("/kafka/produce", params={"topic": "DistributedTracing"})
        self.consume_response = weblog.get("/kafka/consume")
