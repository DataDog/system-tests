    ...
    def test_parser(self):
        ...
        assert manifest == {
            "tests/apm_tracing_e2e/test_otel.py::Test_Otel_Span": [
                {
                    "excluded_library_version": CustomSpec(">=3.4.5"),
                    "declaration": "missing_feature",
                    "library": "java",
                },
                {"declaration": "missing_feature (missing /e2e_otel_span endpoint on weblog)", "library": "python"},
            ],
            "tests/appsec/api_security/test_api_security_rc.py::Test_API_Security_RC_ASM_DD_scanners": [
                {"declaration": "missing_feature", "library": "java"},
                {
                    "excluded_library_version": CustomSpec(">=2.6.0"),
                    "declaration": "missing_feature",
                    "library": "python",
                },
            ],
            "tests/appsec/api_security/test_endpoint_discovery.py::Test_Endpoint_Discovery": [
                {
                    ...
                    "excluded_library_version": CustomSpec(">=1.2.3"),
                    "declaration": "missing_feature",
                    "library": "java",
                },
                {"weblog": "spring-boot", "declaration": "missing_feature", "library": "java"},
                {
                ...
                {
                    "weblog": "django-poc",
                    "excluded_library_version": CustomSpec(">=3.12.0-dev"),
                    "declaration": "missing_feature",
                    "library": "python",
                },
                {
            ...
            "tests/appsec/api_security/test_schemas.py::Test_Scanners": [
                {
                    ...
                    "excluded_library_version": CustomSpec(">=2.4.0"),
                    "declaration": "missing_feature",
                    "library": "python",
                },
                {"weblog": "fastapi", "declaration": "missing_feature", "library": "python"},
            ],
            "tests/appsec/api_security/test_schemas.py::Test_Schema_Request_Cookies": [
                {
                    "excluded_weblog": ["fastapi"],
                    "excluded_library_version": CustomSpec(">=2.1.0"),
                    "declaration": "missing_feature",
                    "library": "python",
                },
                {
                    "weblog": "fastapi",
                    "excluded_library_version": CustomSpec(">=2.5.0"),
                    "declaration": "missing_feature",
                    "library": "python",
                },
            ],
            "tests/appsec/iast/sink": [{"declaration": "missing_feature", "library": "python"}],
            "tests/appsec/iast": [
                {
                    "excluded_library_version": CustomSpec(">=2.1.0"),
                    "declaration": "missing_feature",
