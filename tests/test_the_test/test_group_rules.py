...
def test_tracer_release():
    ...
    not_in_tracer_release_group = [
        ...
        scenarios.go_proxies_appsec_api_security,
        scenarios.go_proxies_appsec_api_security_rc,
        scenarios.go_proxies_appsec_blocking_full_denylist,
        scenarios.go_proxies_appsec_api_security_no_response_body,
