...
class Test_Deserializer:
    def test_deserialize_http_message(self):
    ...
    def test_uncompress_agent_v1_trace_with_span_links(self):
    ...
    def test_deserialize_v1_trace_with_span_links(self):
        ...
        # Order: "hello" (1), "rum" (2), "some-global" (3), "cool-value" (4),
        #       "my-service" (5), "span-name" (6), "foo" (7), "bar" (8),
        #       "tracestate-ref" (9), "tracestate-value" (10), "span-type" (11),
        #       "some-env" (12), "my-version" (13), "my-component" (14),
        #       "link-key" (15), "link-value" (16)
        content = msgpack.packb(
            {
                2: "hello",
                11: [
                                ...
                                11: [
                                    {
                                        ...
                                        4: 10,  # trace_state as string reference (index into strings array, "tracestate-value")
                                        5: 2147483649,  # flags
                                    }
                                ],
                                13: "some-env",
