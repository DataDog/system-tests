...
def _clear_nodejs_runtime_env(monkeypatch):
    for env_name in [
...
def test_infer_minimum_nodejs_runtime_for_ci_from_library_version(monkeypatch):
...
def test_infer_minimum_nodejs_runtime_for_ci_from_ref(monkeypatch):
    _clear_nodejs_runtime_env(monkeypatch)
...
def test_filter_nodejs_runtimes_for_ci(monkeypatch):
    _clear_nodejs_runtime_env(monkeypatch)
