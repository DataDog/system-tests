...
class Test_ComputeLibrariesAndScenarios:
    ...
    def test_json_modification(self):
        ...
        assert_github_processor(
            ...
            3600,
            "false",
            "DEBUGGER_CAPTURE_TIMEOUT,DEBUGGER_EVALUATION_TIMEOUT,DEBUGGER_EXCEPTION_REPLAY,DEBUGGER_EXCEPTION_REPLAY_2,DEBUGGER_EXPRESSION_LANGUAGE,DEBUGGER_EXPRESSION_LANGUAGE_2,DEBUGGER_INPRODUCT_ENABLEMENT,DEBUGGER_PII_REDACTION,DEBUGGER_PROBES_SNAPSHOT,DEBUGGER_PROBES_SNAPSHOT_WITH_SCM,DEBUGGER_SYMDB,DEBUGGER_TELEMETRY,DEFAULT,TRACING_CONFIG_NONDEFAULT_4",
            "",
        )
