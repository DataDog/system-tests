...
class Test_AppSecEventSpanTags:
    ...
    @bug(
        context.library < f"python@{PYTHON_RELEASE_GA_1_1}", reason="a PR was not included in the release",
    )
    @bug(
        context.library < "java@1.2.0", weblog_variant="spring-boot-openliberty", reason="APPSEC-6734",
    )
