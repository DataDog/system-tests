...
class TestLFIAttempt(BaseTestCase):
    ...
    def test_uri(self):
        ...
        interfaces.library.assert_waf_attack(r, pattern=r"(/)?\.\./", address="server.request.uri.raw")
    ...
    def test_headers(self):
        ...
        interfaces.library.assert_waf_attack(r, pattern=r"(/)?\.\./", address="server.request.headers.no_cookies")
