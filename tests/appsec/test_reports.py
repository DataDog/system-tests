...
@released(dotnet="1.28.6", java="0.92.0", nodejs="2.0.0", php_appsec="0.1.0", python="0.57.3")
...
@released(dotnet="1.30.0", nodejs="2.0.0", php_appsec="0.2.0", python="0.57.3")
...
@released(dotnet="2.0.0", java="0.87.0", nodejs="2.0.0", php="0.68.2", python="0.57.3")
@released(golang="1.35.0" if context.weblog_variant == "echo" else "1.34.0")
