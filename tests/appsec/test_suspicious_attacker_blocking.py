...
class Test_Suspicious_Attacker_Blocking:
    ...
    def setup_block_suspicious_attacker(self):
        self.config_state_1 = rc.backend_rc_state.reset().apply()
        self.response_1 = weblog.get("/waf/", headers=HEADERS_ATTACKER)

        self.config_state_2 = rc.backend_rc_state.set_config(*CONFIG_ENABLED).apply()
        self.response_2 = weblog.get("/waf/", headers=HEADERS_ATTACKER)

        self.config_state_3 = (
            rc.backend_rc_state.set_config(*BLOCK_405).set_config(*EXCLUSIONS).set_config(*EXCLUSION_DATA).apply()
        )
        ...
        self.config_state_4 = rc.backend_rc_state.set_config(*BLOCK_416).apply()
        ...
        self.config_state_5 = rc.backend_rc_state.del_config(EXCLUSION_DATA[0]).apply()
        ...
        self.config_state_6 = rc.backend_rc_state.reset().apply()
