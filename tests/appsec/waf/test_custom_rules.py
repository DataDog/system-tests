...
class Test_CustomRules:
    ...
    def test_normal_custom_rule(self):
        interfaces.agent.assert_waf_attack(self.cr1, pattern="custom_rule1", address="server.request.query")
        interfaces.agent.assert_waf_attack(self.cr2, pattern="custom_rule2", address="server.request.query")
