...
@released(dotnet="1.28.6", java="0.87.0", nodejs="2.0.0", php_appsec="0.1.0", python="0.57.3")
...
@released(golang="?", nodejs="2.0.0", php_appsec="0.1.0", python="0.57.3")
...
@released(golang="1.35.0" if context.weblog_variant == "echo" else "1.33.1")
@released(java="0.87.0", nodejs="2.0.0", php_appsec="0.1.0", python="0.57.3")
...
@released(golang="?", java="0.87.0", nodejs="2.0.0", php_appsec="0.1.0", python="0.57.3")
...
@released(golang="?", nodejs="2.0.0", php="1.0.0", php_appsec="0.1.0", python="0.57.3")
@flaky(context.library <= "php@0.68.2")
