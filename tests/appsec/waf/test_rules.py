...
@released(dotnet="1.28.6", java="0.87.0", nodejs="2.0.0", php_appsec="0.1.0", python="1.1.0rc2")
...
@released(golang="1.36.1", nodejs="2.0.0", php_appsec="0.1.0", python="1.1.0rc2")
@missing_feature(context.library <= "golang@1.36.2" and context.weblog_variant == "gin")
...
@released(golang="1.35.0")
@released(java="0.87.0", nodejs="2.0.0", php_appsec="0.1.0", python="1.1.0rc2")
@missing_feature(context.library <= "golang@1.36.2" and context.weblog_variant == "gin")
...
@released(golang="1.35.0", nodejs="2.0.0", php_appsec="0.1.0", python="1.1.0rc2")
@flaky(context.library <= "php@0.68.2")
@missing_feature(context.library <= "golang@1.36.2" and context.weblog_variant == "gin")
