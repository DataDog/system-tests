...
@released(golang="1.36.1", nodejs="2.0.0", php_appsec="0.1.0", python="1.1.0rc1")
@missing_feature(context.library <= "golang@1.36.2" and context.weblog_variant == "gin")
...
@released(golang="1.35.0")
@released(java="0.87.0", nodejs="2.0.0", php_appsec="0.1.0", python="1.1.0rc1")
@missing_feature(context.library <= "golang@1.36.2" and context.weblog_variant == "gin")
...
@released(golang="1.35.0", nodejs="2.0.0", php_appsec="0.1.0", python="1.1.0rc1")
@flaky(context.library <= "php@0.68.2")
@missing_feature(context.library <= "golang@1.36.2" and context.weblog_variant == "gin")
