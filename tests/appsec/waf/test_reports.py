...
class Test_Monitoring:
    ...
    def test_waf_monitoring(self):
        ...
        def validate_waf_monitoring_span_tags(span: DataDogSpan, appsec_data: dict):  # noqa: ARG001
    ...
    def test_waf_monitoring_optional(self):
        ...
        def validate_waf_span_tags(span: DataDogSpan, appsec_data: dict):  # noqa: ARG001
            metrics = span["metrics"]
