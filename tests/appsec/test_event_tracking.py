...
@released(dotnet="2.27.0", golang="1.47.0", java="1.8.0", php_appsec="0.6.0", python="1.9.0", ruby="1.9.0")
...
@released(dotnet="2.27.0", golang="1.47.0", java="1.8.0", php_appsec="0.6.0", python="1.10.0", ruby="1.9.0")
@irrelevant(_is_spring_native_weblog, reason="GraalVM. Tracing support only")
@coverage.basic
