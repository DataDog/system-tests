...
class Test_UserLoginSuccessEvent:
    ...
    def test_user_login_success_event(self):
        ...
        interfaces.agent.validate_one_span(self.r, validator=validate_user_login_success_tags)
...
class Test_UserLoginFailureEvent:
    ...
    def test_user_login_failure_event(self):
        ...
        interfaces.agent.validate_one_span(self.r, validator=validate_user_login_failure_tags)
...
class Test_CustomEvent:
    ...
    def test_custom_event_event(self):
        ...
        interfaces.agent.validate_one_span(self.r, validator=validate_custom_event_tags)
