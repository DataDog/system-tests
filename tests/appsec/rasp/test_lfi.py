...
class Test_Lfi_RC_CustomAction:
    ...
    def setup_lfi_get(self):
        self.config_state_1 = rc.backend_rc_state.reset().set_config(*RemoteConfigConstants.CONFIG_ENABLED).apply()
        self.config_state_1b = rc.backend_rc_state.set_config(*RemoteConfigConstants.RULES).apply()
        self.r1 = weblog.get("/rasp/lfi", params={"file": "../etc/passwd"})

        self.config_state_2 = rc.backend_rc_state.set_config(*RemoteConfigConstants.BLOCK_505).apply()
        self.r2 = weblog.get("/rasp/lfi", params={"file": "../etc/passwd"})

        self.config_state_3 = rc.backend_rc_state.set_config(*RemoteConfigConstants.BLOCK_REDIRECT).apply()
        self.r3 = weblog.get("/rasp/lfi", params={"file": "../etc/passwd"}, allow_redirects=False)

        self.config_state_4 = rc.backend_rc_state.del_config(RemoteConfigConstants.BLOCK_REDIRECT[0]).apply()
