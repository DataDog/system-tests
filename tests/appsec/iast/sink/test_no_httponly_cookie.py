...
from tests.appsec.iast.utils import BaseSinkTest, BaseTestCookieNameFilter, validate_extended_location_data, validate_stack_traces
...
class TestNoHttponlyCookie_ExtendedLocation:
