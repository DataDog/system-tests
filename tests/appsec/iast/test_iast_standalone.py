...
class Test_IASTSecStandalone_UpstreamPropagation:
    """APM correctly propagates IAST events in distributing tracing."""
    ...
    def setup_no_iast_upstream__no_vuln__is_kept_with_priority_1__from_minus_1(self):
    ...
    def test_no_iast_upstream__no_vuln__is_kept_with_priority_1__from_minus_1(self):
        spans_checked = 0
    ...
    def setup_no_iast_upstream__no_vuln__is_kept_with_priority_1__from_0(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/requestdownstream",
    ...
    def test_no_iast_upstream__no_vuln__is_kept_with_priority_1__from_0(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": None, "_dd.p.other": "1"}
        tested_metrics = {"_sampling_priority_v1": lambda x: x < 2}
    ...
    def setup_no_iast_upstream__no_vuln__is_kept_with_priority_1__from_1(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/requestdownstream",
    ...
    def test_no_iast_upstream__no_vuln__is_kept_with_priority_1__from_1(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": None, "_dd.p.other": "1"}
        tested_metrics = {"_sampling_priority_v1": lambda x: x < 2}
    ...
    def setup_no_iast_upstream__no_vuln__is_kept_with_priority_1__from_2(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/requestdownstream",
    ...
    def test_no_iast_upstream__no_vuln__is_kept_with_priority_1__from_2(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": None, "_dd.p.other": "1"}
        tested_metrics = {"_sampling_priority_v1": lambda x: x < 2}
    ...
    def setup_no_upstream_iast_propagation__with_vuln__is_kept_with_priority_2__from_minus_1(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/iast/requestdownstream",
            headers={
                "x-datadog-trace-id": str(trace_id),
                "x-datadog-parent-id": str(parent_id),
                "x-datadog-origin": "rum",
    ...
    def test_no_upstream_iast_propagation__with_vuln__is_kept_with_priority_2__from_minus_1(self):
        spans_checked = 0
    ...
    def setup_no_upstream_iast_propagation__with_vuln__is_kept_with_priority_2__from_0(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/iast/requestdownstream",
    ...
    @bug(library="java", weblog_variant="jersey-grizzly2", reason="APPSEC-55001")
    @bug(library="java", weblog_variant="play", reason="APPSEC-55001")
    def test_no_upstream_iast_propagation__with_vuln__is_kept_with_priority_2__from_0(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": "1"}
        tested_metrics = {"_sampling_priority_v1": lambda x: x == 2}
    ...
    def setup_upstream_iast_propagation__no_vuln__is_propagated_as_is__being_0(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/requestdownstream",
    ...
    def test_upstream_iast_propagation__no_vuln__is_propagated_as_is__being_0(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": "1"}
    ...
    def setup_upstream_iast_propagation__no_vuln__is_propagated_as_is__being_1(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/requestdownstream",
    ...
    def test_upstream_iast_propagation__no_vuln__is_propagated_as_is__being_1(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": "1"}
    ...
    def setup_upstream_iast_propagation__no_vuln__is_propagated_as_is__being_2(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/requestdownstream",
    ...
    def test_upstream_iast_propagation__no_vuln__is_propagated_as_is__being_2(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": "1"}
        tested_metrics = {"_sampling_priority_v1": lambda x: x == 2}
    ...
    def setup_any_upstream_propagation__with_vuln__raises_priority_to_2__from_minus_1(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/iast/requestdownstream",
    ...
    @bug(library="java", weblog_variant="jersey-grizzly2", reason="APPSEC-55001")
    @bug(library="java", weblog_variant="play", reason="APPSEC-55001")
    def test_any_upstream_propagation__with_vuln__raises_priority_to_2__from_minus_1(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": "1"}
        tested_metrics = {"_sampling_priority_v1": lambda x: x == 2}
    ...
    def setup_any_upstream_propagation__with_vuln__raises_priority_to_2__from_0(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/iast/requestdownstream",
    ...
    @bug(library="java", weblog_variant="jersey-grizzly2", reason="APPSEC-55001")
    @bug(library="java", weblog_variant="play", reason="APPSEC-55001")
    def test_any_upstream_propagation__with_vuln__raises_priority_to_2__from_0(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": "1"}
        tested_metrics = {"_sampling_priority_v1": lambda x: x == 2}
    ...
    def setup_any_upstream_propagation__with_vuln__raises_priority_to_2__from_1(self):
        trace_id = 1212121212121212121
        parent_id = 34343434
        self.r = weblog.get(
            "/iast/requestdownstream",
    ...
    @bug(library="java", weblog_variant="jersey-grizzly2", reason="APPSEC-55001")
    @bug(library="java", weblog_variant="play", reason="APPSEC-55001")
    def test_any_upstream_propagation__with_vuln__raises_priority_to_2__from_1(self):
        spans_checked = 0
        tested_meta = {"_dd.p.appsec": "1"}
        tested_metrics = {"_sampling_priority_v1": lambda x: x == 2}
