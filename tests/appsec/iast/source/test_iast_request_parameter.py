...
class TestRequestParameter:
    ...
    def test_parameter(self):
        weblog.post(
            "/iast/source/parameter/test", data={"source": "parameter", "value": "parameterValue"}
        )
        interfaces.library_stdout.wait()
        testSource = re.escape('tainted={"value":"parameter","ranges":[{"source":{"origin":"http.request.parameter","name":"source","value":"parameter"},"start":0,"length":9}]}')
        interfaces.library_stdout.assert_presence(testSource, level="DEBUG")
        testValue = re.escape('tainted={"value":"parameterValue","ranges":[{"source":{"origin":"http.request.parameter","name":"value","value":"parameterValue"},"start":0,"length":14}]}')
