...
class Test_Automated_User_Blocking:
    def setup_user_blocking_auto(self):
        ...
        self.config_state_1 = rc.backend_rc_state.set_config(*BLOCK_USER).apply()
        self.config_state_2 = rc.backend_rc_state.set_config(*BLOCK_USER_DATA).apply()
...
class Test_Automated_Session_Blocking:
    def setup_session_blocking(self):
        ...
        self.config_state_1 = rc.backend_rc_state.set_config(*BLOCK_SESSION).apply()
        self.config_state_2 = rc.backend_rc_state.set_config(*BLOCK_SESSION_DATA).apply()
        self.r_home_blocked = weblog.get(
            "/",
