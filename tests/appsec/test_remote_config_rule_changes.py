...
class Test_BlockingActionChangesWithRemoteConfig:
    ...
    def setup_block_405(self):
        self.config_state_1 = rc.backend_rc_state.reset().set_config(*CONFIG_ENABLED).apply()
        self.response_1 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})

        self.config_state_2 = rc.backend_rc_state.set_config(*BLOCK_405).apply()
        self.response_2 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})

        self.config_state_3 = rc.backend_rc_state.set_config(*BLOCK_505).apply()
        self.response_3 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})

        self.config_state_4 = rc.backend_rc_state.set_config(*BLOCK_REDIRECT).apply()
        self.response_4 = weblog.get(
            "/waf/", headers={"User-Agent": "dd-test-scanner-log-block"}, allow_redirects=False
        )

        self.config_state_5 = rc.backend_rc_state.reset().apply()
...
class Test_UpdateRuleFileWithRemoteConfig:
    ...
    def setup_update_rules(self):
        ...
        self.config_state_2 = rc.backend_rc_state.set_config(*RULE_FILE).apply()
        self.response_2 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})
        self.response_2b = weblog.get("/waf/", headers={"User-Agent": "Arachni/v1"})

        self.config_state_3 = rc.backend_rc_state.set_config(*BLOCK_405).apply()
        self.response_3 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})
        self.response_3b = weblog.get("/waf/", headers={"User-Agent": "Arachni/v1"})

        self.config_state_4 = rc.backend_rc_state.del_config(RULE_FILE[0]).apply()
...
class Test_AsmDdMultiConfiguration:
    ...
    def setup_update_rules(self):
        rc.backend_rc_state.reset().apply()
        ...
        self.config_state_1 = rc.backend_rc_state.set_config(*FIRST_RULE_FILE).apply()
        ...
        self.config_state_2 = rc.backend_rc_state.set_config(*SECOND_RULE_FILE).apply()
        ...
        self.config_state_3 = rc.backend_rc_state.del_config(FIRST_RULE_FILE[0]).apply()
        ...
        self.config_state_4 = rc.backend_rc_state.del_config(SECOND_RULE_FILE[0]).apply()
    ...
    def setup_update_rules_with_rules_compat(self):
        ...
        # The Anubis rule is introduced alongside TechnoViking
        self.config_state_2 = rc.backend_rc_state.set_config(*RULES_COMPAT_FILE).apply()
        self.response_2a = weblog.get("/waf/", headers={"User-Agent": "TechnoViking/v1"})
        self.response_2b = weblog.get("/waf/", headers={"User-Agent": "Anubis/v1"})
        ...
        # Back to Default, Arachni should be available
        self.config_state_4 = rc.backend_rc_state.del_config(RULES_COMPAT_FILE[0]).apply()
        self.response_4a = weblog.get("/waf/", headers={"User-Agent": "Anubis/v1"})
        self.response_4b = weblog.get("/waf/", headers={"User-Agent": "Arachni/v1"})
...
class Test_Unknown_Action:
    def setup_unknown_action(self):
        ...
        self.config_state_2 = rc.backend_rc_state.set_config(*FOO_ACTION).apply()
        self.response_2 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})

        self.config_state_3 = rc.backend_rc_state.reset().apply()
        self.response_3 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})
...
class Test_Multiple_Actions:
    def setup_multiple_actions(self):
        ...
        self.config_state_2 = rc.backend_rc_state.set_config(*BLOCK_FOO_ACTION).apply()
        self.response_2 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})
...
class Test_Empty_Config:
    def setup_empty_config(self):
        ...
        self.config_state_2 = rc.backend_rc_state.set_config(*EMPTY_CONFIG).apply()
        self.response_2 = weblog.get("/waf/", headers={"User-Agent": "dd-test-scanner-log-block"})
...
class Test_Invalid_Config:
    def setup_invalid_config(self):
        ...
        self.config_state_2 = rc.backend_rc_state.set_config(*DUPLICATE_ID_CONFIG).apply()
