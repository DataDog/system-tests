...
class Test_UserBlocking_FullDenylist:
    ...
    def setup_blocking_test_single_usr(self):
        self.r_block = weblog.get("/users", params={"user": 0})

    def test_blocking_test_single_usr(self):
        """Test with a denylisted user"""

        def validate_blocking_test_single_usr(span):
        ...
        interfaces.library.validate_spans(self.r_block, validator=validate_blocking_test_single_usr)
