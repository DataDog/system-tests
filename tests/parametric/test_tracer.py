...
class Test_TracerSCITagging:
    ...
    # @missing_feature(context.library == "golang", reason="golang does not strip credentials yet") # causing easy wins
    @missing_feature(context.library == "nodejs", reason="nodejs does not strip credentials yet") # causing easy wins
