...
VARIABLE_NAME = "OTEL_BLRP_SCHEDULE_DELAY"
DEFAULT_VALUE = 1000
STABLE_VALUE = 17
ZERO_VALUE = 0
INVALID_VALUE = -1
...
@features.otel_blrp_schedule_delay
class Test_OTEL_BLRP_SCHEDULE_DELAY:
    @pytest.mark.parametrize(
        ("library_env", "expected_value"),
        [pytest.param({**BLRP_LIBRARY_ENV, VARIABLE_NAME: STABLE_VALUE}, STABLE_VALUE, id="17")],
    )
