...
VARIABLE_NAME = "OTEL_EXPORTER_OTLP_METRICS_TIMEOUT"
...
def _timeout_value(test_agent: TestAgentAPI, test_library: APMLibrary) -> int:
    with test_library as library:
        library.otel_get_meter("otel-exporter-otlp-metrics-timeout", "1.0.0", "", {})
...
@features.otel_exporter_otlp_metrics_timeout
class Test_OTEL_EXPORTER_OTLP_METRICS_TIMEOUT:
