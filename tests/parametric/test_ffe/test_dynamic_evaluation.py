...
def _load_ufc_fixture() -> dict[str, Any]:
    ...
    fixture_path = Path(__file__).parent / "ffe-system-test-data" / "ufc-config.json"
...
def _get_test_case_files() -> list[str]:
    ...
    test_data_dir = Path(__file__).parent / "ffe-system-test-data" / "evaluation-cases"
...
class Test_Feature_Flag_Dynamic_Evaluation:
    ...
    def test_ffe_flag_evaluation(self, test_case_file: str, test_agent: TestAgentAPI, test_library: APMLibrary) -> None:
        ...
        test_case_path = Path(__file__).parent / "ffe-system-test-data" / "evaluation-cases" / test_case_file
