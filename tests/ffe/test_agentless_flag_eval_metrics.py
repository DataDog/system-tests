...
class Test_FFE_Agentless_Eval_Metric:
    ...
    def setup_agentless_eval_metric(self) -> None:
        ...
        if self.response.status_code == 200:
            wait_for_telemetry(self._matches_metric, "feature_flag.evaluations metric")

    def _matches_metric(self, data: JSON) -> bool:
        return any(
    ...
    def test_agentless_eval_metric(self) -> None:
        ...
        assert_expected_telemetry_route(self._matches_metric, "feature_flag.evaluations metric")
