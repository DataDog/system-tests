...
@released(dotnet="2.7.0", java="?", php="0.85.0")
...
@released(dotnet="2.26.0", java="?", php="0.85.0", python=PYTHON_RELEASE_GA_1_1, ruby="?")
@coverage.basic
...
@rfc("https://docs.google.com/document/d/1T3qAE5nol18psOaHESQ3r-WRiZWss9nyGmroShug8ao/edit#heading=h.3wmduzc8mwe1")
@released(dotnet="2.27.0", java="?", php="0.85.0", python="1.9.0", ruby="?")
@coverage.basic
