...
@released(python="1.7.0", dotnet="2.12.0", java="0.108.1", nodejs="3.2.0", ruby="1.4.0", php="0.90")
...
@released(dotnet="2.35.0", java="?", python="1.17.3", nodejs="?", php="0.90", ruby="1.11")
...
@released(dotnet="2.12.0", ruby="?", nodejs="?", php="?", python="?", java="?")
@irrelevant(library="cpp")
@missing_feature(weblog_variant="spring-boot-3-native", reason="GraalVM. Tracing support only")
...
@released(dotnet="2.35.0", java="1.7.0", nodejs="?", php="?", python="?", ruby="1.4.0")
...
@released(dotnet="2.35.0", java="?", nodejs="?", php="?", python="?", ruby="?")
...
@released(dotnet="?", java="?", nodejs="?", php="?", python="?", ruby="1.4.0")
...
@released(dotnet="2.35.0", java="?", nodejs="?", php="?", python="?", ruby="1.4.0")
