...
class Test_TelemetryV2:
    ...
    def test_config_telemetry_completeness(self):
        ...
        def load_telemetry_json(filename):
            with open(f"tests/telemetry_intake/configs-static/{filename}.json", encoding="utf-8") as fh:
...
class Test_Telemetry_Metrics_Schema:
    def test_no_unexpected_telemetry_metrics(self):
        ...
        def load_telemetry_json(filename):
            with open(f"tests/telemetry_intake/metrics-static/{filename}.json", encoding="utf-8") as fh:
                return json.load(fh)
