...
class Test_Telemetry:
    ...
    def _validate_session_id_headers_across_processes(self) -> None:
        ...
        # ignore metrics and log events which can be generated by lib-datadog. These events
        # contain runtime/session_ids which do not map to telemetry generated by the tracer.
