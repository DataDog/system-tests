...
class TestDockerSSIAppsecFeatures:
    ...
    @irrelevant(context.library >= "nodejs@6.0.0-0" and context.installed_language_runtime < "22.0")
    @irrelevant(context.library < "nodejs@6.0.0-0" and context.installed_language_runtime < "17.0")
