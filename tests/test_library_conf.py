...
from utils._context.header_tag_vars import (
    ...
    RESPONSE_WILDCARD_TAG_PREFIX,
    REQUEST_WILDCARD_TAG_PREFIX,
    TAG_COLON_LEADING,
    TAG_COLON_TRAILING,
    TAG_LONG,
    TAG_SHORT,
...
class Test_HeaderTags_Wildcard_Request_Headers:
    ...
    def test_trace_header_tags(self):
        ...
        for key in response_headers:
            assert REQUEST_WILDCARD_TAG_PREFIX + key in span["meta"]
...
class Test_HeaderTags_Wildcard_Response_Headers:
    ...
    def test_trace_header_tags(self):
        ...
        span = spans[0]
        for key in response_headers:
            assert RESPONSE_WILDCARD_TAG_PREFIX + key in span["meta"]
