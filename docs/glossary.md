...
- disabled: A test is disabled when it is marked with `bug`, `missing_feature`, `flaky`, `irrelevant`, or `incomplete_test_app`. Disabled tests don't cause CI to fail regardless of their outcome
