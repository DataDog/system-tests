...
## \[GET,POST\] /login`
This endpoint is used to aunthenticate a user.
Body fields accepted in POST method:
- `username`: the login name for the user.
- `password`: password for the user.
It also supports HTTP authentication by using GET method and using the authorization header.
...
- `sdk_user`: user id to be used in the sdk calling.
- `sdk_mail`: user's mail to be used in the sdk calling.
