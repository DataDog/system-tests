...
The full system-tests suite is run every night in the system-tests repo CI with the
last production version of each tracer. This catches regressions in system-tests
itself and finds early bugs that could halt merges on other repositories. However,
...
quality control, each repository is responsible for running system-tests on its
default branch regularly (if possible for each commit) and monitoring the results.

Below is a breakdown of the default branch runs per repository.

- system-tests: nightly runs in [GitHub CI](https://github.com/DataDog/system-tests/actions/workflows/nightly.yml) ([file](https://github.com/DataDog/system-tests/blob/main/.github/workflows/nightly.yml))
...
- dd-trace-py: runs on every new commit on default and on a schedule in [GitHub CI](https://github.com/DataDog/dd-trace-py/actions/workflows/system-tests.yml) ([file](https://github.com/DataDog/dd-trace-py/blob/main/.github/workflows/system-tests.yml))
    ...
    Also runs tests for python_lambda: scenario group lambda_end_to_end
...
- dd-trace-rb: runs on every new commit on default and on a schedule in [GitHub CI](https://github.com/DataDog/dd-trace-rb/actions/workflows/system-tests.yml?query=branch%3Amaster) ([file](https://github.com/DataDog/dd-trace-rb/blob/master/.github/workflows/system-tests.yml))
    scenario: OK
    test optimization push: OK
- dd-trace-dotnet: nightly runs in [GitHub CI](https://github.com/DataDog/dd-trace-dotnet/actions/workflows/system-tests-nightly.yml) ([file](https://github.com/DataDog/dd-trace-dotnet/blob/master/.github/workflows/system-tests-nightly.yml))
...
- dd-trace-cpp: runs on every new commit on default and on a schedule in [GitHub CI](https://github.com/DataDog/dd-trace-cpp/actions/workflows/main.yml) ([file](https://github.com/DataDog/dd-trace-cpp/blob/7a55843f51eb3e3707bec816b7e0a4f9446b1eb9/.github/workflows/main.yml#L16))
    scenario: OK
- httpd-datadog: runs on every new commit on default in [GitHub CI](https://github.com/DataDog/httpd-datadog/actions/workflows/system-tests.yml) ([file](https://github.com/DataDog/httpd-datadog/blob/main/.github/workflows/system-tests.yml))
