...
class MsSqlServerContainer(SqlDbTestedContainer):
    def __init__(self) -> None:
        healthcheck = {
            ...
            "test": "bash -c \"(/opt/mssql-tools18/bin/sqlcmd -S 127.0.0.1 -U sa -P 'yourStrong(!)Password' -Q 'SELECT 1' -b -C) 2>/dev/null || /opt/mssql-tools/bin/sqlcmd -S 127.0.0.1 -U sa -P 'yourStrong(!)Password' -Q 'SELECT 1' -b -C\"",
            "retries": 20,
        }
