...
class Ubuntu22amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            "Ubuntu_22_amd64",
            aws_config=_AWSConfig(ami_id="ami-007855ac798b5175e", ami_instance_type="t4g.medium", user="ubuntu"),
...
class Ubuntu18amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            "Ubuntu_18_amd64",
            aws_config=_AWSConfig(ami_id="ami-0263e4deb427da90e", ami_instance_type="t4g.medium", user="ubuntu"),
...
class AmazonLinux2amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            ...
            aws_config=_AWSConfig(ami_id="ami-0dfcb1ef8550277af", ami_instance_type="t4g.medium", user="ec2-user"),
...
class AmazonLinux2DotNet6(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            ...
            aws_config=_AWSConfig(ami_id="ami-005b11f8b84489615", ami_instance_type="t4g.medium", user="ec2-user"),
            vagrant_config=None,
            krunvm_config=None,
            os_type="linux",
            os_distro="rpm",
...
class AmazonLinux2023amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            ...
            aws_config=_AWSConfig(ami_id="ami-064ed2d3fc01d3ec1", ami_instance_type="t4g.medium", user="ec2-user"),
...
class Centos7amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            "CentOS_7_amd64",
            aws_config=_AWSConfig(ami_id="ami-002070d43b0a4f171", ami_instance_type="t4g.medium", user="centos"),
            # vagrant_config=_VagrantConfig(box_name="generic-a64/alma9"),
            vagrant_config=None,
            krunvm_config=None,
            os_type="linux",
...
class OracleLinux92amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            ...
            aws_config=_AWSConfig(ami_id="ami-01453ca80e53609e3", ami_instance_type="t4g.medium", user="ec2-user"),
            vagrant_config=None,
            krunvm_config=None,
            os_type="linux",
            os_distro="rpm",
...
class OracleLinux88amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            ...
            aws_config=_AWSConfig(ami_id="ami-02a7419f257858fad", ami_instance_type="t4g.medium", user="ec2-user"),
            vagrant_config=None,
            krunvm_config=None,
            os_type="linux",
            os_distro="rpm",
...
class OracleLinux79amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            ...
            aws_config=_AWSConfig(ami_id="ami-0fb08d5eb039a9ebd", ami_instance_type="t4g.medium", user="ec2-user"),
            vagrant_config=None,
            krunvm_config=None,
            os_type="linux",
            os_distro="rpm",
...
class AlmaLinux8amd64(_VirtualMachine):
    def __init__(self, **kwargs) -> None:
        super().__init__(
            "AlmaLinux_8_amd64",
            aws_config=_AWSConfig(ami_id="ami-0825c833650fed842", ami_instance_type="t4g.medium", user="ec2-user"),
            vagrant_config=None,
            krunvm_config=None,
            os_type="linux",
            os_distro="rpm",
    ...
    def __init__(self, **kwargs) -> None:
        super().__init__(
            ...
            aws_config=_AWSConfig(
                ami_id="ami-0c2163c916f8dd3c8", ami_instance_type="t4g.medium", user="ec2-user"
            ),  # 9.4
            vagrant_config=None,
            krunvm_config=None,
            os_type="linux",
