...
class DockerSSIScenario(Scenario):
    ...
    def __init__(
        ...
        self._weblog_injection = DockerSSIContainer(self.host_log_folder, extra_env_vars=extra_env_vars)
        self._agent_container = APMTestAgentContainer(self.host_log_folder, agent_port=self.agent_port)
