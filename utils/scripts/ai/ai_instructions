...
* To register a new virtual machine, please ask the user for the name and all other fields required to define a virtual machine entry in virtual_machines.json. Always refer to the structure of virtual_machines.json to ensure all necessary fields are collected when registering a new VM.
