...
NOT_SUPPPORTED=("APM_TRACING_E2E_OTEL" "PARAMETRIC" "OTEL_INTEGRATIONS" "OTEL_LOG_E2E" "OTEL_METRIC_E2E" "OTEL_TRACING_E2E" "APM_TRACING_E2E_SINGLE_SPAN" "INTEGRATION_FRAMEWORKS_OPENAI" "INTEGRATION_FRAMEWORKS_ANTHROPIC")
