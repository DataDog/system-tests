...
NOT_SUPPPORTED=("K8S_LIB_INJECTION_BASIC" "K8S_LIB_INJECTION_FULL" "TRACE_PROPAGATION_STYLE_W3C" "APM_TRACING_E2E_OTEL" "CROSSED_TRACING_LIBRARIES" "APPSEC_AUTO_EVENTS_RC")
