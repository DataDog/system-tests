...
def print_gitlab_pipeline(language, matrix_data, ci_environment) -> None:
    ...
    if matrix_data["aws_ssi_scenario_defs"]:
        ...
        if os.getenv("CI_PROJECT_NAME") != "system-tests":
            ...
            result_pipeline[".base_job_onboarding_system_tests"]["script"].insert(0, "git clone https://git@github.com/DataDog/system-tests.git system-tests")
    ...
    if matrix_data["libinjection_scenario_defs"]:
        ...
        if os.getenv("CI_PROJECT_NAME") != "system-tests":
            ...
            result_pipeline[".k8s_lib_injection_base"]["script"].insert(0, "git clone https://git@github.com/DataDog/system-tests.git system-tests")
        ...
        for weblog_name, images in weblogs.items():
            ...
            for architecture in architectures:
                ...
                if os.getenv("CI_PROJECT_NAME") != "system-tests":
                    ...
                    result_pipeline[vm_job]["script"].insert(0, "git clone https://git@github.com/DataDog/system-tests.git system-tests")
