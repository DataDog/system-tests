...
if [ "$TARGET" = "java" ]; then
    ...
    COMMIT_ID=$(curl --silent https://api.github.com/repos/DataDog/dd-trace-go/branches/dario.castane/AIT-8717/isolate-contribs-batch-5 | jq --raw-output '.commit.sha')
