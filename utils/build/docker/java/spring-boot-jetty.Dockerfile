...
COPY ./utils/build/docker/java/spring-boot/sprint-boot-jetty.dep.lock .
COPY ./utils/build/docker/java/spring-boot/pom.xml .
RUN ./install_dependencies.sh sprint-boot-jetty.dep.lock -Pjetty

COPY ./utils/build/docker/java/spring-boot/src ./src
RUN mvn -Pjetty package
