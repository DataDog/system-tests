...
COPY ./utils/build/docker/java/spring-boot/spring-boot-jetty.dep.lock .
COPY ./utils/build/docker/java/spring-boot/pom.xml .
RUN ./install_dependencies.sh spring-boot-jetty.dep.lock -Pjetty

COPY ./utils/build/docker/java/spring-boot/src ./src
RUN mvn -Pjetty package -DskipTests
