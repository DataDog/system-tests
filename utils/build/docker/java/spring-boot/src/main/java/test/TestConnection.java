...
public class TestConnection implements Connection {
    ...
    // createStatement overloads return TestStatement so the tracer instruments them
    // and the DBM-injected SQL is captured before reaching the real statement.

    @Override
    public Statement createStatement() throws SQLException {
        return new TestStatement(delegate.createStatement(), lastSql);
    }

    @Override
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new TestStatement(delegate.createStatement(resultSetType, resultSetConcurrency), lastSql);
    }

    @Override
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new TestStatement(delegate.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability), lastSql);
    }

    // ---- all remaining methods simply delegate ----
