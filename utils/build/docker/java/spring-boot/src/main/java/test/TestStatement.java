...
public class TestStatement implements Statement {
    ...
    private final AtomicReference<String> lastSql;

    public TestStatement(Statement delegate, AtomicReference<String> lastSql) {
    ...
    // ---- execute methods: capture SQL then delegate ----
