...
# docker build --progress=plain -f utils/build/docker/nodejs/nextjs.base.Dockerfile -t datadog/system-tests:nextjs.base-v4 .
# docker push datadog/system-tests:nextjs.base-v4
