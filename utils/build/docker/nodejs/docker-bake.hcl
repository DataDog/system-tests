...
target "express4" {
  ...
  tags       = ["datadog/system-tests:express4.base-v4"]
}
...
target "express5" {
  ...
  tags       = ["datadog/system-tests:express5.base-v4"]
}
...
target "fastify" {
  ...
  tags       = ["datadog/system-tests:fastify.base-v4"]
}
...
target "express4-typescript" {
  ...
  tags       = ["datadog/system-tests:express4-typescript.base-v4"]
}
...
target "nextjs" {
  ...
  tags       = ["datadog/system-tests:nextjs.base-v4"]
}
