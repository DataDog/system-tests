...
public class DatadogProvider : global::OpenFeature.FeatureProvider
{
    ...
    public override Task<ResolutionDetails<bool>> ResolveBooleanValueAsync(string flagKey, bool defaultValue, EvaluationContext? context = null, CancellationToken cancellationToken = default)
    {
        ...
        var res = Datadog.Trace.FeatureFlags.FeatureFlagsSdk.Evaluate(flagKey, Datadog.Trace.FeatureFlags.ValueType.Boolean, defaultValue, ToContext(context));
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        var res = Datadog.Trace.FeatureFlags.FeatureFlagsSdk.Evaluate(flagKey, Datadog.Trace.FeatureFlags.ValueType.Numeric, defaultValue, ToContext(context));
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        var res = Datadog.Trace.FeatureFlags.FeatureFlagsSdk.Evaluate(flagKey, Datadog.Trace.FeatureFlags.ValueType.Integer, defaultValue, ToContext(context));
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        var res = Datadog.Trace.FeatureFlags.FeatureFlagsSdk.Evaluate(flagKey, Datadog.Trace.FeatureFlags.ValueType.String, defaultValue, ToContext(context));
    ...
    {
        cancellationToken.ThrowIfCancellationRequested();
        var res = Datadog.Trace.FeatureFlags.FeatureFlagsSdk.Evaluate(flagKey, Datadog.Trace.FeatureFlags.ValueType.Json, defaultValue, ToContext(context));
