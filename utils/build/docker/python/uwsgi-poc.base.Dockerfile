...
RUN pip install 'flask[async]'==3.1.1 flask-login==0.6.3 uWSGI==2.0.30 gevent==25.5.1 requests==2.32.4 pycryptodome==3.23.0 psycopg2-binary==2.9.10 confluent-kafka==2.10.1 graphene==3.4.3
