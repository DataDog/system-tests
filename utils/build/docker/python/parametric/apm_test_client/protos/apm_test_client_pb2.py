...
StartSpanArgs = _reflection.GeneratedProtocolMessageType(
    "StartSpanArgs",
    (_message.Message,),
    {
        "DESCRIPTOR": _STARTSPANARGS,
        "__module__": "parametric.protos.apm_test_client_pb2"
        # @@protoc_insertion_point(class_scope:StartSpanArgs)
    },
)
_sym_db.RegisterMessage(StartSpanArgs)

DistributedHTTPHeaders = _reflection.GeneratedProtocolMessageType(
...
HeaderTuple = _reflection.GeneratedProtocolMessageType(
    "HeaderTuple",
    (_message.Message,),
    {
...
StartSpanReturn = _reflection.GeneratedProtocolMessageType(
    "StartSpanReturn",
    (_message.Message,),
    {
...
InjectHeadersArgs = _reflection.GeneratedProtocolMessageType(
    "InjectHeadersArgs",
    (_message.Message,),
    {
...
InjectHeadersReturn = _reflection.GeneratedProtocolMessageType(
    "InjectHeadersReturn",
    (_message.Message,),
    {
...
FinishSpanArgs = _reflection.GeneratedProtocolMessageType(
    "FinishSpanArgs",
    (_message.Message,),
    {
...
FinishSpanReturn = _reflection.GeneratedProtocolMessageType(
    "FinishSpanReturn",
    (_message.Message,),
    {
...
SpanSetMetaArgs = _reflection.GeneratedProtocolMessageType(
    "SpanSetMetaArgs",
    (_message.Message,),
    {
...
SpanSetMetaReturn = _reflection.GeneratedProtocolMessageType(
    "SpanSetMetaReturn",
    (_message.Message,),
    {
...
SpanSetMetricArgs = _reflection.GeneratedProtocolMessageType(
    "SpanSetMetricArgs",
    (_message.Message,),
    {
...
SpanSetMetricReturn = _reflection.GeneratedProtocolMessageType(
    "SpanSetMetricReturn",
    (_message.Message,),
    {
...
SpanSetErrorArgs = _reflection.GeneratedProtocolMessageType(
    "SpanSetErrorArgs",
    (_message.Message,),
    {
...
SpanSetErrorReturn = _reflection.GeneratedProtocolMessageType(
    "SpanSetErrorReturn",
    (_message.Message,),
    {
...
HTTPRequestArgs = _reflection.GeneratedProtocolMessageType(
    "HTTPRequestArgs",
    (_message.Message,),
    {
...
HTTPRequestReturn = _reflection.GeneratedProtocolMessageType(
    "HTTPRequestReturn",
    (_message.Message,),
    {
...
FlushSpansArgs = _reflection.GeneratedProtocolMessageType(
    "FlushSpansArgs",
    (_message.Message,),
    {
...
FlushSpansReturn = _reflection.GeneratedProtocolMessageType(
    "FlushSpansReturn",
    (_message.Message,),
    {
...
FlushTraceStatsArgs = _reflection.GeneratedProtocolMessageType(
    "FlushTraceStatsArgs",
    (_message.Message,),
    {
...
FlushTraceStatsReturn = _reflection.GeneratedProtocolMessageType(
    "FlushTraceStatsReturn",
    (_message.Message,),
    {
...
OtelStartSpanArgs = _reflection.GeneratedProtocolMessageType(
    "OtelStartSpanArgs",
    (_message.Message,),
    {
...
OtelStartSpanReturn = _reflection.GeneratedProtocolMessageType(
    "OtelStartSpanReturn",
    (_message.Message,),
    {
...
OtelEndSpanArgs = _reflection.GeneratedProtocolMessageType(
    "OtelEndSpanArgs",
    (_message.Message,),
    {
...
OtelEndSpanReturn = _reflection.GeneratedProtocolMessageType(
    "OtelEndSpanReturn",
    (_message.Message,),
    {
...
OtelForceFlushArgs = _reflection.GeneratedProtocolMessageType(
    "OtelForceFlushArgs",
    (_message.Message,),
    {
...
OtelForceFlushReturn = _reflection.GeneratedProtocolMessageType(
    "OtelForceFlushReturn",
    (_message.Message,),
    {
...
OtelFlushSpansArgs = _reflection.GeneratedProtocolMessageType(
    "OtelFlushSpansArgs",
    (_message.Message,),
    {
...
OtelFlushSpansReturn = _reflection.GeneratedProtocolMessageType(
...
OtelFlushTraceStatsArgs = _reflection.GeneratedProtocolMessageType(
    "OtelFlushTraceStatsArgs",
    (_message.Message,),
    {
...
OtelFlushTraceStatsReturn = _reflection.GeneratedProtocolMessageType(
    "OtelFlushTraceStatsReturn",
    (_message.Message,),
    {
...
OtelStopTracerArgs = _reflection.GeneratedProtocolMessageType(
    "OtelStopTracerArgs",
    (_message.Message,),
    {
...
OtelStopTracerReturn = _reflection.GeneratedProtocolMessageType(
    "OtelStopTracerReturn",
    (_message.Message,),
    {
...
OtelIsRecordingArgs = _reflection.GeneratedProtocolMessageType(
    "OtelIsRecordingArgs",
    (_message.Message,),
    {
...
OtelIsRecordingReturn = _reflection.GeneratedProtocolMessageType(
    "OtelIsRecordingReturn",
    (_message.Message,),
    {
...
OtelSpanContextArgs = _reflection.GeneratedProtocolMessageType(
    "OtelSpanContextArgs",
    (_message.Message,),
    {
...
OtelSpanContextReturn = _reflection.GeneratedProtocolMessageType(
    "OtelSpanContextReturn",
    (_message.Message,),
    {
...
OtelSetStatusArgs = _reflection.GeneratedProtocolMessageType(
    "OtelSetStatusArgs",
    (_message.Message,),
    {
...
OtelSetStatusReturn = _reflection.GeneratedProtocolMessageType(
    "OtelSetStatusReturn",
    (_message.Message,),
    {
...
OtelSetNameArgs = _reflection.GeneratedProtocolMessageType(
    "OtelSetNameArgs",
    (_message.Message,),
    {
...
OtelSetNameReturn = _reflection.GeneratedProtocolMessageType(
    "OtelSetNameReturn",
    (_message.Message,),
    {
...
OtelSetAttributesArgs = _reflection.GeneratedProtocolMessageType(
    "OtelSetAttributesArgs",
    (_message.Message,),
    {
...
OtelSetAttributesReturn = _reflection.GeneratedProtocolMessageType(
    "OtelSetAttributesReturn",
    (_message.Message,),
    {
...
Attributes = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "KeyValsEntry": _reflection.GeneratedProtocolMessageType(
            "KeyValsEntry",
            (_message.Message,),
            {
...
ListVal = _reflection.GeneratedProtocolMessageType(
    "ListVal",
    (_message.Message,),
    {
        "DESCRIPTOR": _LISTVAL,
...
AttrVal = _reflection.GeneratedProtocolMessageType(
    "AttrVal",
    (_message.Message,),
    {
        "DESCRIPTOR": _ATTRVAL,
...
StopTracerArgs = _reflection.GeneratedProtocolMessageType(
    "StopTracerArgs",
    (_message.Message,),
    {
...
StopTracerReturn = _reflection.GeneratedProtocolMessageType(
    "StopTracerReturn",
    (_message.Message,),
    {
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _STARTSPANARGS._serialized_start = 44
    _STARTSPANARGS._serialized_end = 310
    _DISTRIBUTEDHTTPHEADERS._serialized_start = 312
    _DISTRIBUTEDHTTPHEADERS._serialized_end = 372
    _HEADERTUPLE._serialized_start = 374
    _HEADERTUPLE._serialized_end = 415
    _STARTSPANRETURN._serialized_start = 417
    _STARTSPANRETURN._serialized_end = 469
    _INJECTHEADERSARGS._serialized_start = 471
    _INJECTHEADERSARGS._serialized_end = 507
    _INJECTHEADERSRETURN._serialized_start = 509
    _INJECTHEADERSRETURN._serialized_end = 599
    _FINISHSPANARGS._serialized_start = 601
    _FINISHSPANARGS._serialized_end = 629
    _FINISHSPANRETURN._serialized_start = 631
    _FINISHSPANRETURN._serialized_end = 649
    _SPANSETMETAARGS._serialized_start = 651
    _SPANSETMETAARGS._serialized_end = 713
    _SPANSETMETARETURN._serialized_start = 715
    _SPANSETMETARETURN._serialized_end = 734
    _SPANSETMETRICARGS._serialized_start = 736
    _SPANSETMETRICARGS._serialized_end = 800
    _SPANSETMETRICRETURN._serialized_start = 802
    _SPANSETMETRICRETURN._serialized_end = 823
    _SPANSETERRORARGS._serialized_start = 825
    _SPANSETERRORARGS._serialized_end = 952
    _SPANSETERRORRETURN._serialized_start = 954
    _SPANSETERRORRETURN._serialized_end = 974
    _HTTPREQUESTARGS._serialized_start = 976
    _HTTPREQUESTARGS._serialized_end = 1078
    _HTTPREQUESTRETURN._serialized_start = 1080
    _HTTPREQUESTRETURN._serialized_end = 1120
    _FLUSHSPANSARGS._serialized_start = 1122
    _FLUSHSPANSARGS._serialized_end = 1138
    _FLUSHSPANSRETURN._serialized_start = 1140
    _FLUSHSPANSRETURN._serialized_end = 1158
    _FLUSHTRACESTATSARGS._serialized_start = 1160
    _FLUSHTRACESTATSARGS._serialized_end = 1181
    _FLUSHTRACESTATSRETURN._serialized_start = 1183
    _FLUSHTRACESTATSRETURN._serialized_end = 1206
    _OTELSTARTSPANARGS._serialized_start = 1209
    _OTELSTARTSPANARGS._serialized_end = 1556
    _OTELSTARTSPANRETURN._serialized_start = 1558
    _OTELSTARTSPANRETURN._serialized_end = 1614
    _OTELENDSPANARGS._serialized_start = 1616
    _OTELENDSPANARGS._serialized_end = 1683
    _OTELENDSPANRETURN._serialized_start = 1685
    _OTELENDSPANRETURN._serialized_end = 1704
    _OTELFORCEFLUSHARGS._serialized_start = 1706
    _OTELFORCEFLUSHARGS._serialized_end = 1743
    _OTELFORCEFLUSHRETURN._serialized_start = 1745
    _OTELFORCEFLUSHRETURN._serialized_end = 1784
    _OTELFLUSHSPANSARGS._serialized_start = 1786
    _OTELFLUSHSPANSARGS._serialized_end = 1823
    _OTELFLUSHSPANSRETURN._serialized_start = 1825
    _OTELFLUSHSPANSRETURN._serialized_end = 1864
    _OTELFLUSHTRACESTATSARGS._serialized_start = 1866
    _OTELFLUSHTRACESTATSARGS._serialized_end = 1891
    _OTELFLUSHTRACESTATSRETURN._serialized_start = 1893
    _OTELFLUSHTRACESTATSRETURN._serialized_end = 1920
    _OTELSTOPTRACERARGS._serialized_start = 1922
    _OTELSTOPTRACERARGS._serialized_end = 1942
    _OTELSTOPTRACERRETURN._serialized_start = 1944
    _OTELSTOPTRACERRETURN._serialized_end = 1966
    _OTELISRECORDINGARGS._serialized_start = 1968
    _OTELISRECORDINGARGS._serialized_end = 2006
    _OTELISRECORDINGRETURN._serialized_start = 2008
    _OTELISRECORDINGRETURN._serialized_end = 2053
    _OTELSPANCONTEXTARGS._serialized_start = 2055
    _OTELSPANCONTEXTARGS._serialized_end = 2093
    _OTELSPANCONTEXTRETURN._serialized_start = 2095
    _OTELSPANCONTEXTRETURN._serialized_end = 2211
    _OTELSETSTATUSARGS._serialized_start = 2213
    _OTELSETSTATUSARGS._serialized_end = 2284
    _OTELSETSTATUSRETURN._serialized_start = 2286
    _OTELSETSTATUSRETURN._serialized_end = 2307
    _OTELSETNAMEARGS._serialized_start = 2309
    _OTELSETNAMEARGS._serialized_end = 2357
    _OTELSETNAMERETURN._serialized_start = 2359
    _OTELSETNAMERETURN._serialized_end = 2378
    _OTELSETATTRIBUTESARGS._serialized_start = 2380
    _OTELSETATTRIBUTESARGS._serialized_end = 2453
    _OTELSETATTRIBUTESRETURN._serialized_start = 2455
    _OTELSETATTRIBUTESRETURN._serialized_end = 2480
    _ATTRIBUTES._serialized_start = 2482
    _ATTRIBUTES._serialized_end = 2596
    _ATTRIBUTES_KEYVALSENTRY._serialized_start = 2540
    _ATTRIBUTES_KEYVALSENTRY._serialized_end = 2596
    _LISTVAL._serialized_start = 2598
    _LISTVAL._serialized_end = 2630
    _ATTRVAL._serialized_start = 2632
    _ATTRVAL._serialized_end = 2735
    _STOPTRACERARGS._serialized_start = 2737
    _STOPTRACERARGS._serialized_end = 2753
    _STOPTRACERRETURN._serialized_start = 2755
    _STOPTRACERRETURN._serialized_end = 2773
    _APMCLIENT._serialized_start = 2776
    _APMCLIENT._serialized_end = 3998
