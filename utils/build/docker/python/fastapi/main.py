...
@app.get("/iast/sampling-by-route-method-count/<str:id>/", response_class=PlainTextResponse)
@app.post("/iast/sampling-by-route-method-count/<str:id>/", response_class=PlainTextResponse)
