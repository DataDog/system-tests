...
RUN pip install 'flask[async]'==2.2.4 flask-login==0.6.3 gunicorn==21.2.0 gevent==24.2.1 requests==2.32.3 pycryptodome==3.20.0 psycopg2-binary==2.9.9 confluent-kafka==2.1.1 graphql-core==3.2.6 flask-graphql==2.0.1 graphene==3.4.3
...
# docker build --progress=plain -f utils/build/docker/python/flask-poc.base.Dockerfile -t datadog/system-tests:flask-poc.base-v8 .
