...
# Debian 11 LTS ended 2026-08-31; live deb.debian.org/security.debian.org repos 404 now, and
# archive.debian.org doesn't mirror bullseye-security yet — pin to a snapshot.debian.org
