<?php
// Test endpoint for RFC-1076: API Security sampling when tracers lack HTTP routes
// Behavior controlled by ?case= query parameter
...
switch ($case) {
    ...
    case 'computed':
        ...
        echo json_encode([
            ...
            // This will be checked by the test to ensure http.endpoint was NOT set
