...
# main module (systemtests.weblog) does not contain package systemtests.weblog/echo.v5-orchestrion
WORKDIR /app/echo.v5-orchestrion
...
COPY --from=build /app/echo.v5-orchestrion/SYSTEM_TESTS_LIBRARY_VERSION /app/SYSTEM_TESTS_LIBRARY_VERSION
