...
protoc -I="../../../../parametric/protos" --go_out=. --go_opt=Mprotos/apm_test_client.proto=. --go-grpc_out=. --go-grpc_opt=Mprotos/apm_test_client.proto=. "../../../../parametric/protos/apm_test_client.proto"
