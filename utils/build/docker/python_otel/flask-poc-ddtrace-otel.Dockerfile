...
#Set opentelemetry to 0.42b0 due this bug: https://github.com/open-telemetry/opentelemetry-python-contrib/issues/2046
...
CMD gunicorn -w 1 -b 0.0.0.0:7777 --access-logfile - app:app -k gevent
