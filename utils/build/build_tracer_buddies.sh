...
docker_build -f utils/build/docker/python/flask-poc.Dockerfile -t datadog/system-tests:python_buddy-v1 .
...
docker_build -f utils/build/docker/ruby/rails70.Dockerfile -t datadog/system-tests:ruby_buddy-v1 .
