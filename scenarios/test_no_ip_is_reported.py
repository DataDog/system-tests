...
import socket
from utils import BaseTestCase, interfaces, coverage, scenario
...
class Test_NoIpIsReported(BaseTestCase):
    ...
    def test_no_ip(self):
        ...
        interfaces.agent.add_validation(validator, is_success_on_expiry=True)
