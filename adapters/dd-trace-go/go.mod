module ddtracego-adapter

// dd-trace-go v2 requires a Go 1.25 toolchain. This repo's default `go` is
// 1.19, which cannot build v2 (and cannot auto-download a toolchain). Build
// with a pinned, STABLE Go 1.25 install:
//
...
//
// See README.md for the toolchain download recipe.
go 1.25.0
